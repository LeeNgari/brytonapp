...
export interface ApiBoardingPassBoardingPass
  extends Struct.CollectionTypeSchema {
  collectionName: 'boarding_passes';
  info: {
    displayName: 'Boarding Pass';
    pluralName: 'boarding-passes';
...
export interface ApiMileageTrackerMileageTracker
  ...
  info: {
    displayName: 'Mileage Tracker';
    pluralName: 'mileage-trackers';
  ...
  attributes: {
    ...
    EndMileage: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mileage-tracker.mileage-tracker'
    > &
      Schema.Attribute.Private;
    NumberPlate: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    StartMileage: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
